    ...
    return (
        <div className="presentation-container">
                ...
                <div className="slide-content">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="bg-light p-8 rounded-xl shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300 border border-gray-200">
                            ...
                            <p className="text-dark text-xl md:text-2xl font-semibold">El concepto artístico europeo no se transmite de forma consistente.</p>
                        </div>
                        <div className="bg-light p-8 rounded-xl shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300 border border-gray-200">
                            ...
                            <p className="text-dark text-xl md:text-2xl font-semibold">El staff carece de guion de storytelling.</p>
                        </div>
                        <div className="bg-light p-8 rounded-xl shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105 duration-300 border border-gray-200">
                           ...
                           <p className="text-dark text-xl md:text-2xl font-semibold">Pocas actividades culturales que prolonguen estancias.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="slide3" className="slide bg-primary-dark">
                 <div className="slide-content">
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-12 text-center">Nuestra propuesta consiste en:</h2>
                    <div className="max-w-5xl mx-auto space-y-8">
                        <div className="bg-light p-6 rounded-xl shadow-lg flex items-center space-x-6 border border-gray-200">
                            ...
                            <p className="text-dark text-xl md:text-2xl font-semibold">Diseñar un calendario mensual de experiencias culturales.</p>
                        </div>
                        <div className="bg-light p-6 rounded-xl shadow-lg flex items-center space-x-6 border border-gray-200">
                            ...
                            <p className="text-dark text-xl md:text-2xl font-semibold">Capacitar al staff en storytelling de marca.</p>
                        </div>
                        <div className="bg-light p-6 rounded-xl shadow-lg flex items-center space-x-6 border border-gray-200">
                            ...
                            <p className="text-dark text-xl md:text-2xl font-semibold">Integrar actividades en paquetes y campañas digitales.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="slide-content">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="bg-light p-8 rounded-xl shadow-lg flex flex-col items-center text-center border border-gray-200 h-full justify-center">
                            ...
                            <h3 className="font-semibold text-xl md:text-2xl text-dark">Diferenciación como único art-hotel en Guadalajara.</h3>
                        </div>
                        <div className="bg-light p-8 rounded-xl shadow-lg flex flex-col items-center text-center border border-gray-200 h-full justify-center">
                            ...
                            <h3 className="font-semibold text-xl md:text-2xl text-dark">Mayor fidelización y recomendaciones.</h3>
                        </div>
                        <div className="bg-light p-8 rounded-xl shadow-lg flex flex-col items-center text-center border border-gray-200 h-full justify-center">
                            ...
                            <h3 className="font-semibold text-xl md:text-2xl text-dark">Estancias más largas y valiosas.</h3>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="slide5" className="slide bg-primary-dark">
                <div className="slide-content">
                    ...
                    <div className="max-w-4xl mx-auto space-y-6">
                        {[
                            "Calendario mensual de experiencias.",
                            "Manual de storytelling para staff.",
                            "Campañas digitales integradas."
                        ].map((item, index) => (
                ...
                <div className="slide-content">
                    ...
                    <div className="timeline-container">
                        <div className="timeline-item timeline-left">
                            <div className="timeline-content"><h3 className="text-xl md:text-2xl font-bold text-dark">% huéspedes que participan en experiencias.</h3></div>
                        </div>
                        <div className="timeline-item timeline-right">
                            <div className="timeline-content"><h3 className="text-xl md:text-2xl font-bold text-dark">Menciones de “arte/europeo” en reseñas.</h3></div>
                        </div>
                        <div className="timeline-item timeline-left">
                            <div className="timeline-content"><h3 className="text-xl md:text-2xl font-bold text-dark">Tasa de repetición.</h3></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="slide7" className="slide bg-primary-dark">
                <div className="slide-content text-center">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-8 max-w-5xl mx-auto">
